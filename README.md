...
- [ ] Explain what a token is used for.
      It is a credential is used to access an API. It grants access to the API and you get the token thru a request, frmo local storage and save it in your post request.
- [ ] What steps can you take in your web apps to keep your data secure?
      You can create private routes or pages, and handle your state in different ways within your app
- [ ] Describe how web servers work.
      It uses HTTP that form the files that users see on their webpages
